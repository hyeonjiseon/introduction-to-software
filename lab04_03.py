#입차 시간과 출차 시간을 입력 받아 주차요금을 계산하는 프로그램
#입/출차 시간 입력 범위 오류 시 다시 입력 받음
#최대 24시간 주차 가능
#기본 30분: 1500원, 추가 15분마다 600원, 하루 최대 12000원 넘지 않음
#주차 시간 계산할 때 올림으로 계산 - math.ceil(x): 올림 함수 ex)math.ceil(32.233)=33
#오후에 입차 후 다음 날 오전 출차 시 요금 계산 가능하게
#자정을 넘길 경우 두 번째 날은 새로 계산 시작
# 예) 23:00 입차, 2:00 출차 - 3시간 주차
#     첫째 날: 1시간(기본 1500 + 30분 1200 = 2700원)
#     둘째 날: 2시간(기본 1500 + 1시간30분 3600 = 5100원)
#     총 3700원 + 5100원 = 7800원
